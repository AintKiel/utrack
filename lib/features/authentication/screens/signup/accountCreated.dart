      ...
      body: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              ///Title & SubTitle
              Text(UTexts.accountCreated, style: Theme.of(context).textTheme.headlineSmall,),
              const SizedBox(height: Usizes.spaceBtwItems),
              Text(UTexts.yourAccountCreatedSubTitle, style: Theme.of(context).textTheme.labelMedium?.copyWith(
