...
class DueDatesList extends StatelessWidget {
  ...
  const DueDatesList({super.key, required this.dueDates, required this.formatter});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        ...dueDates.map((due) {
          final totalWithInterest = due['original'] + (due['original'] * due['interest'] / 100);
          return Container(
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Due: ${due['date']}', style: const TextStyle(fontWeight: FontWeight.w500)),
                      const SizedBox(height: 6),
                      Row(
                        children: [
                          UIconsNoPad.pesoSign(size: 13, color: Colors.black87),
                          const SizedBox(width: 2),
                          Text(formatter.format(due['amount']),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          const Text('Initial: ', style: TextStyle(color: Colors.black87, fontSize: 12)),
