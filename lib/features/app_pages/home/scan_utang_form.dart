...
class ScanUtangFormPopup extends StatefulWidget {
  const ScanUtangFormPopup({super.key});

  @override
  State<ScanUtangFormPopup> createState() => _ScanUtangFormPopupState();
}

class _ScanUtangFormPopupState extends State<ScanUtangFormPopup> {
